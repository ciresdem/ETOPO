...
tile_list_csv = os.path.join(os.path.split(__file__)[0], "..", "data", "sample_tile_list.csv")
data_sources = ['Copernicus', 'NASADEM', 'MERIT', 'AW3D30', "TanDEM-X"]
...
def build_wkt_bbox(df_row):
    ...
    ymin = df_row["Ymin"]
    ymax = df_row["Ymax"]
    return geometry.Polygon([(xmin, ymin), (xmin, ymax), (xmax, ymax), (xmax, ymin), (xmin, ymin)]).wkt
